...
enum AppSettings<T> {
  ...
  pushNotificationsGatewayUrl<String>(
    ...
    'https://push.gaussian.tech/_matrix/push/v1/notify',
  ),
  ...
  applicationName<String>('chat.fluffy.application_name', 'GaussInteract'),
  ...
  website<String>('chat.fluffy.website_url', 'https://gaussian.tech'),
  logoUrl<String>(
    'chat.fluffy.logo_url',
    'https://gaussian.tech/assets/favicon.png',
  ),
  privacyPolicy<String>(
    'chat.fluffy.privacy_policy_url',
    'https://gaussian.tech/privacy',
  ),
  tos<String>('chat.fluffy.tos_url', 'https://gaussian.tech/tos'),
